...
namespace QuickMCP.Abstractions;
...
public interface IMcpServerInfoBuilder
{
    ...
    /// <summary>
    /// Sets the base URL for the server configuration.
    /// </summary>
    /// <param name="baseUrl">The base URL of the server as a string.</param>
    /// <returns>A builder instance for method chaining.</returns>
    IMcpServerInfoBuilder WithBaseUrl(string baseUrl);
